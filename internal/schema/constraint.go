...
var ConstraintSchema = &schema.BodySchema{
	Attributes: map[string]*schema.AttributeSchema{
		...
		"operator": {
			...
			Constraint: schema.OneOf{
				schema.LiteralValue{Value: cty.StringVal("=")},
				schema.LiteralValue{Value: cty.StringVal("!=")},
				schema.LiteralValue{Value: cty.StringVal(">")},
				schema.LiteralValue{Value: cty.StringVal(">=")},
				schema.LiteralValue{Value: cty.StringVal("<")},
				schema.LiteralValue{Value: cty.StringVal("distinct_hosts")},
				schema.LiteralValue{Value: cty.StringVal("distinct_property")},
				schema.LiteralValue{Value: cty.StringVal("regexp")},
				schema.LiteralValue{Value: cty.StringVal("set_contains")},
				schema.LiteralValue{Value: cty.StringVal("set_contains_any")},
				schema.LiteralValue{Value: cty.StringVal("version")},
				schema.LiteralValue{Value: cty.StringVal("semver")},
				schema.LiteralValue{Value: cty.StringVal("is_set")},
				schema.LiteralValue{Value: cty.StringVal("is_not_set")},
			},
			IsOptional: true,
		},
		"value": {
