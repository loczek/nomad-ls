	...
	Attributes: map[string]*schema.AttributeSchema{
		...
		"capabilities": {
			...
			Constraint: schema.OneOf{
				...
				RegisterJobCapability,
				RevertJobCapability,
				DeregisterJobCapability,
				PurgeJobCapability,
				EvaluateJobCapability,
				PlanJobCapability,
				TagJobVersionCapability,
				StableJobCapability,
				FailDeploymentCapability,
				PauseDeploymentCapability,
				PromoteDeploymentCapability,
				UnblockDeploymentCapability,
				CancelDeploymentCapability,
				SetAllocHealthDeploymentCapability,
				ForcePeriodicJobCapability,
				PauseAllocationCapability,
				GcAllocationCapability,
				DeleteServiceRegistrationCapability,
			},
			IsRequired: true,
		},
	},
